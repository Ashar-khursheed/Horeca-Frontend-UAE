...
const MOCK_TICKETS: Ticket[] = [
  {
    id: "T-2",
    subject: "dsadasdas adasd",
    description: "dsadasdas dsadas asdasd as dansd jnas",
    category: "Account Management",
    priority: "Low",
    status: "Open",
    dateSubmitted: "May 23, 2026",
    lastUpdated: "May 23, 2026",
  },
  {
    id: "T-1",
    subject: "Unable to download invoice #INV-441",
    description: "I have been trying to download invoice #INV-441 but it keeps showing a blank page. I have tried on Chrome and Safari.",
    category: "Billing",
    priority: "High",
    status: "Resolved",
...
const CATEGORIES  = ["Technical Support", "Billing", "Account Management", "Product Inquiry", "Feedback"];
...
export default function SupportPage() {
  ...
  const [form, setForm] = useState({
    ...
    company:  customer?.business_detail?.business_name ?? "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSuccess(false);
      setView("list");
      setForm({ ...EMPTY_FORM, fullName: customer?.name ?? "", email: customer?.email ?? "", company: customer?.business_detail?.business_name ?? "" });
      setAttachments([]);
      setErrors({});
    }, 1800);
  };
      ...
      <div className="p-4 sm:p-6 max-w-6xl">
        ...
        <div className="bg-white rounded-[10px] border border-gray-100 shadow-sm px-5 py-4 mb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-900">Ticket #{selected.id.replace("T-", "1000")}</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-5 items-start">
          {/* ── Left: Subject + Description + Responses ─────────────────── */}
            ...
            <div className="bg-white rounded-[10px] border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center py-14 px-4 text-center">
                ...
                <p className="text-xs text-gray-400">
                  Our support team will respond {EXPECTED_TIME[selected.priority].toLowerCase()}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-72 shrink-0 space-y-4">
            ...
            <div className="bg-blue-50 rounded-[10px] border border-blue-100 p-5">
              ...
              <p className="text-xs text-blue-600 mb-4">For urgent issues, you can contact our support team directly</p>
              <a
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              Need help? Submit a support request and our team will get back to you shortly. You can also track the status of existing tickets here.
            </p>
          </div>
          <button
        ...
        <section className="bg-white rounded-[10px] border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Company Name">
              <input value={form.company} onChange={set("company")} placeholder="Enter company name" className={iCls(false)} />
            </Field>
