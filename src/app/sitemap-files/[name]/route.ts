...
const VALID_SITEMAPS: Record<string, string> = {
  ...
  "images-main":       "frontend/images.xml?part=main",
  "images-products-1": "frontend/images.xml?part=products-1",
  "images-products-2": "frontend/images.xml?part=products-2",
  "images-products-3": "frontend/images.xml?part=products-3",
  "images-products-4": "frontend/images.xml?part=products-4",
