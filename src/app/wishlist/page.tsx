          ...
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            {items.length > 0 && (
              <div className="flex items-center gap-2">
                ...
                <button className="flex items-center gap-2 px-4 py-2 rounded-[7px] bg-[#A6131D] hover:bg-[#8b1018] text-white text-sm font-semibold transition-colors duration-200">
                  <FileText size={15} />
                  Get Instant Quote
                </button>
              </div>
