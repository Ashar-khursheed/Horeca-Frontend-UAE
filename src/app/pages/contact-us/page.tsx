      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-gray-900 mb-3">
            Get in Touch{" "}
            <span className="text-[#186737]">with Us</span>
          </h1>
          <p className="text-gray-500 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
            HorecaStore&apos;s dedicated support team is here to assist restaurants,
            hotels, cafes, and foodservice businesses with fast, reliable service.
            Contact us by phone, email, or through our online form — we&apos;re
            committed to making your experience smooth and efficient.
          </p>
      ...
      <section id="form" className="max-w-6xl mx-auto px-4 sm:px-6 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            <h2 className="text-lg font-black text-gray-900 mb-1">Get in Touch</h2>
            <p className="text-xs text-gray-400 mb-6">We typically reply within 24–48 hours on business days.</p>
            ...
            {sent ? (
              <div className="flex flex-col items-center text-center py-10">
                ...
                <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
                  ...
                  <span className="font-semibold text-[#186737]">{form.email}</span>{" "}
                  within 24–48 hours.
                </p>
                <button
                  onClick={() => {
                    setSent(false);
                    setForm({ name: "", email: "", phone: "", countryCode: "+1", orderId: "", message: "", consent: false });
                    setFile(null);
                  }}
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className={`flex h-11 rounded-[9px] border overflow-hidden transition-all ${
                      ...
                      <input
                        type="tel"
                        value={form.phone}
                        onChange={(e) => { set("phone", e.target.value); clr("phone"); }}
                ...
                <div>
                  ...
                  >
                    <Paperclip size={14} className="text-gray-400 group-hover:text-[#186737] shrink-0 transition-colors" />
                  ...
                  />
                  <p className="text-[11px] text-gray-400 mt-1">Images, PDFs up to 5MB</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    value={form.message}
                    onChange={(e) => { set("message", e.target.value); clr("message"); }}
                ...
                <label className="flex items-start gap-2.5 cursor-pointer">
                  ...
                  <span className="text-[11px] text-gray-500 leading-relaxed">
                    By submitting this form, you consent to receive promotional offers from Horecastore. Message &amp; data rates may apply.{" "}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-800">Live Support</h3>
              ...
              <div className="space-y-2 text-xs text-gray-600 mb-4">
                <p className="font-semibold text-gray-700 text-[11px] uppercase tracking-wide">Support Hours</p>
              ...
              <div className="border-t border-gray-100 pt-4 space-y-2">
                <p className="text-[11px] font-semibold text-gray-500 uppercase tracking-wide">Contact Numbers</p>
                <a href="tel:+18664467322" className="flex items-center gap-2 text-sm font-semibold text-[#186737] hover:underline">
                  <Phone size={13} /> (866) 446-7322
                </a>
                <a href="tel:+18664467323" className="flex items-center gap-2 text-sm font-semibold text-[#186737] hover:underline">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-800">Visit Our Showroom</h3>
              ...
              <div className="space-y-1 mb-4">
                <p className="text-xs font-semibold text-gray-700">HorecaStore Showroom</p>
                <p className="text-xs text-gray-500">6802 Bissonet Street, Ste A · Houston, Texas 77074</p>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-800">Quick Reply via WhatsApp</h3>
                  <p className="text-[11px] text-gray-400">Fastest way to reach us</p>
                </div>
              </div>
              <p className="text-xs text-gray-500 leading-relaxed mb-4">
                Need a quick reply? Chat with us on WhatsApp for instant support.
              </p>
              <a
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
              ...
              <div className="min-w-0">
                <p className="text-xs font-semibold text-gray-700">Email Us Directly</p>
                <a href="mailto:support@horecastore.ae" className="text-xs text-[#186737] hover:underline break-all">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500">
              From delivery to returns, we&apos;ve answered the most common questions.
              Still need help?{" "}
              <a href="#form" className="text-[#186737] hover:underline font-medium">
                Chat or email us
              </a>{" "}
