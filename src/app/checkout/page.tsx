...
export default function CheckoutPage() {
  ...
  const [countryCode, setCountryCode] = useState(
    country?.data?.phone_code ?? undefined,
  );
            ...
            <div className="flex-1 min-w-0">
              ...
              {item.shipping > 0 && isUSUser && (
                <div className="flex items-center gap-1 mt-0.5 text-[11px] text-gray-400">
                  <Truck size={10} />  <CurrencySymbol currency={currencySymbolICON} fontsize="15px" />
  ...
  const placeOrderBtn = (
    <>
      ...
      <div
        className={`flex items-start gap-3 p-3 rounded-md border mb-4 ${termsError ? "border-red-400 bg-red-50" : "border-gray-200"}`}
      >
        <input
      ...
      <div className="lg:hidden min-h-screen bg-gray-50">
        ...
        {mobileStep === 2 && (
          <div className="px-4 py-5 pb-36 space-y-4">
            ...
            <div className=" bg-white border-t border-gray-100 px-4 py-3 z-30 shadow-[0_-4px_12px_rgba(0,0,0,0.07)]">
              <div
                className={`flex items-start gap-3 p-3 rounded-md border mb-3 ${termsError ? "border-red-400 bg-red-50" : "border-gray-200"}`}
              >
                <input
                ...
                <div>
                  ...
                  >
                    Please read our Terms and conditions before proceeding with
                    the payments.
                  </label>
                  <button
                    type="button"
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {isPlacingOrder ? (
                    ...
                    <>
                      Place Order <CurrencySymbol currency={currencySymbolICON} fontsize="15px"/>
                      {usd(grandTotal)}
                    </>
                  )}
                </button>
      ...
      >
        <div className="prose prose-sm max-w-none text-gray-700 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <p className="text-gray-900 font-medium">
            ...
            following these steps, you may be eligible to file a claim in case
            of damaged items.
          </p>
          <div className="bg-red-50 border border-red-200 p-3 rounded-md">
            <p className="text-red-700 font-semibold">
              TheHorecaStore.com will not be responsible for any shipment that
              is signed for without complete inspection.
            </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Standard freight delivery means the driver will deliver your order
              to the edge of the truck only.
            </li>
            <li>
              If you select Standard Delivery, you are responsible for unloading
              the shipment.
            </li>
            <li>
              The driver may park the truck at the closest safe location, such
              as a loading dock or delivery entrance.
            </li>
            <li>
              The driver will not unload the freight or bring it inside your
              premises.
            </li>
          </ul>
          <h4 className="text-base font-bold text-gray-900 mt-6 flex items-center gap-2">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Carefully examine the external packaging for any visible damage.
            </li>
            <li>
              If you notice dents, tears, broken pallets, or crushed boxes,{" "}
            ...
            <li>
              Inform the driver that you are refusing delivery due to visible
              damage.
            </li>
            <li>
              <strong className="text-red-600">
                Do not sign the delivery receipt for damaged shipments.
              </strong>
            </li>
          </ul>
          <h4 className="text-base font-bold text-gray-900 mt-6 flex items-center gap-2">
          ...
          <p className="font-semibold text-gray-900">
            You may sign for the shipment only after:
          </p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 mt-4">
            ...
            <p className="text-red-800 text-sm mb-2">
              Once a shipment is signed and accepted:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-sm text-red-700">
              <li>The customer becomes responsible for any freight claims</li>
              <li>
                TheHorecaStore.com is not obligated to replace or compensate for
                transit damage
              </li>
            </ul>
          </div>
      ...
      >
        <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
          ...
          <p>
            ...
            confirms that they have read, understood, and agreed to the
            following terms:
          </p>
          ...
          <p>
            All products, services, and delivery options included in the order
