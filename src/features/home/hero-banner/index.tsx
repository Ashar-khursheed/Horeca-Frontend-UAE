                      ...
                      <SwiperSlide key={item.id}>
                        {item.link ? (
                          <Link href={item.link} className="block w-full h-full outline-none">
                            <div className="relative w-full h-full">
                              {isValid ? (
                                <img src={item.image} alt={item.title ?? "Banner"} className="w-full h-full object-covers" loading={index === 0 ? "eager" : "lazy"} />
                              ) : (
                          ...
                          <div className="relative w-full h-full">
                            {isValid ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center bg-gray-100 text-black  text-sm">No Image</div>
                            )}
                          </div>
                        )}
                      </SwiperSlide>
