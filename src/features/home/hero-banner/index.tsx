...
const HERO_SLIDES = [
  {
    ...
    title: "Commercial Kitchen Equipment",
    link: "/restaurant-equipment",
    image: "https://d1p9kdrbe10xzz.cloudfront.net/production/sliders/main-banner-1150-x-500-b2-2.webp",
    alt: "Commercial Kitchen Equipment",
  },
  {
    id: 2,
    title: "Premium Refrigeration",
    link: "/refrigeration",
    image: "https://d1p9kdrbe10xzz.cloudfront.net/production/sliders/Landing+page+Banner.webp",
    alt: "Refrigeration Units",
  },
  {
    id: 3,
    title: "Hotel & Restaurant Supplies",
    link: "/hotel-supplies",
    image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=900&h=400&fit=crop",
    alt: "Hotel Supplies",
  },
  {
    id: 4,
    title: "Tableware & Disposables",
    link: "/tableware",
    image: "https://d1p9kdrbe10xzz.cloudfront.net/production/sliders/main-banner-1150-x-500-b1-2.webp",
    alt: "Tableware Collection",
  },
];
...
const BannerImage = () => (
  <div className="relative w-full h-full min-h-[155px] rounded-md overflow-hidden">
    <Image
      src={BannerImg}
      fill
      loading="lazy"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-3 lg:gap-4">
              ...
              {HERO_SLIDES.map((banner, index) => (
                <SwiperSlide key={banner.id}>
                  <Link href={banner.link} className="block w-full h-full outline-none">
                    <div className="relative w-full h-full overflow-hidden" style={{ aspectRatio: "875/380" }}>
                      <img
                        src={banner.image}
                        alt={banner.alt}
                        className="w-full h-full object-cover"
          ...
          <div className="lg:col-span-2">
            ...
            <div className="block lg:hidden">
              ...
              >
                <SwiperSlide>
                  <Link href="/starting-a-restaurant" className="block no-underline">
                    <CTACard />
                  </Link>
                </SwiperSlide>
            ...
            <div className="hidden lg:flex flex-col gap-3 h-full">
              <Link href="/starting-a-restaurant" className="no-underline flex-1">
                <CTACard />
              </Link>
