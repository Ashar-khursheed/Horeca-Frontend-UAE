...
const SOCIAL_LINKS = [
  { icon: <><svg width="18" height="18" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</>, href: "https://www.facebook.com/horecastoreamerica", label: "Facebook" },
...
</>, href: "https://www.instagram.com/horecastoreamerica", label: "Instagram" },
  { icon: <><svg width="18" height="18" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</>, href: "https://www.linkedin.com/company/horecastoreamerica/", label: "LinkedIn" },
  { icon: <><svg width="18" height="18" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</>, href: "https://www.youtube.com/@horecastoreinternational", label: "YouTube" },
];
            ...
            <div className="md:flex hidden flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              >
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-black font-semibold text-base"> (866) 446-7322</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-black font-semibold text-base">sales@thehorecastore.com</p>
                </div>
              </a>
            </div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:sales@thehorecastore.com" className="text-[13px] text-gray-700 hover:text-[#186737] transition-colors font-medium">
