...
//       <header
//         ref={headerRef}
//         className="w-full  left-0 right-0 z-50 bg-white transition-shadow duration-300"
//       >
//         <TopBar />
//         <NavigationStatic navItemData={navItemData as any} />
//         <DropdownPanel navItemData={navItemData} />
...
const Header = ({ navItemData = [] }: HeaderProps) => {
  ...
  console.log("Header navItemData:", navItemData);

  return (
    <>
      <header
        ref={headerRef}
        className={`w-full left-0 right-0 z-50 bg-white transition-all duration-300 ${
