      ...
      <div className="bg-white nav-shadows sticky top-0 z-40">
        <div className="global-container mx-auto px-4 lg:px-6">
          <div className="flex items-center justify-between gap-3 lg:gap-5 h-[68px]">
            ...
            {/* ── Search ── */}
            <div className="flex-1 hidden lg:flex items-center border rounded-full px-4 h-11 gap-2 transition-all duration-200 bg-white border-gray-200">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              ...
              >
                <button className="hidden xl:flex items-center gap-2 px-2 py-1.5 rounded-xl hover:bg-gray-50 transition-colors group">
              ...
              <button className="hidden xl:flex relative w-10 h-10 items-center justify-center rounded-xl hover:bg-gray-50 transition-colors group">
                <Heart
                  size={20}
                  className="text-gray-500 group-hover:text-[#186737] transition-colors"
                />
            ...
            <div className="flex md:hidden ">
              <button
                className="lg:hidden flex-shrink-0 w-9 h-9 f rounded-xl text-gray-600 hover:bg-gray-100 transition-colors"
              ...
              <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                ...
                <button
                  className="xl:hidden flex-shrink-0 w-9 h-9 flex items-center justify-center rounded-xl text-gray-600 hover:bg-gray-100 transition-colors"
                  onClick={() => setSheetOpen(true)}
                >
                  <Menu size={20} />
                </button>
